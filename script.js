...
function qwe() {
    ...
    const arr = [name, ads1, ads2, city, zip, state];
...
function isAlpha(event) {
    let keycode = event.keyCode;
    if ((keycode > 64 && keycode < 122) || keycode == 39) {
        return true;
    }
    return false;
}
...
function isAlphanumeric(event) {
    let keycode = event.keyCode;
    if ((keycode > 64 && keycode < 122) || keycode == 39 || (keycode > 48 && keycode < 57)) {
        return true;
    }
    return false;
}
